...
import {createLogger} from "@node_modules/@aspnet/signalr/dist/esm/Utils";
...
export class CreateEventComponent extends AppComponentBase {
    ...
    @ViewChild('createEventModal', {static: false}) modal: ModalDirective;
    ...
    onShown(): void {
        console.log(" $.AdminBSB:", $.AdminBSB," $.AdminBSB.input:", $.AdminBSB.input, "this.modalContent.nativeElement:", this.modalContent.nativeElement);
